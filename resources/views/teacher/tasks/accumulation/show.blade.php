<x-app-layout>
    ...
    <div class="flex justify-end">
        <div class="w-2/6  sm:px-6 lg:px-8 self-end">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="post" class="ml-5" action="#" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            <x-label for="point" :value="__('Point')" />
                            <x-input id="point" class="block mt-1 w-full" type="text" name="point" value="{{ ($data[0]->point !== null) ? $data[0]->point : '0'}}" required />
