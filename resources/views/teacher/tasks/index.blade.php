            ...
            <div class="sm:flex sm:items-center sm:ml-6 mb-2">
                <x-dropdown align="left" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link href="{{ route('teacher.quiz.create', ['class' => Request::segment(3)]) }}">
                    ...
                    <div class="flex justify-between" x-on:click.self="expanded = !expanded">
                        ...
                        <div class="flex self-center mt-3">
                            ...
                            <x-dropdown align="top" width="48" >
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link href="{{ route('teacher.quiz.edit', ['class' => Request::segment(3), 'quiz' => $data->id]) }}">
                                        <i class="fas fa-pencil-alt mr-2"></i>{{ __('Edit') }}
                                    </x-dropdown-link>

                                    <form id="{{ $data->id }}" action="{{ route('teacher.quiz.destroy', ['quiz' => $data->id]) }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <x-dropdown-link href="#" onclick="deleteConfirm('{{ $data->title }}', '{{ $data->id }}')">                                          
                                          <i class="fas fa-trash-alt mr-2"></i>{{ __('Delete') }}
