<x-admin-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex justify-between">
                    ...
                    @endif
                    <form method="post" class="w-full ml-5" action="{{ route('admin.students.update', ['student' => $student->id]) }}" novalidate enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-input id="address" class="block mt-1 w-full" type="text" name="address" value="{{ $student->address }}" required />
    ...
    <x-slot name="script">
        ...
        <script>
            Vue.use(VueToast);
            Vue.$toast.success('Student updated!', {
             duration: 1500,
             dismissible: true,
            })
        </script>
