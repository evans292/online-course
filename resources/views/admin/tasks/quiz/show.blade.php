                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <x-dropdown align="top" width="48" >
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('admin.quiz.edit', ['class' => Request::segment(3), 'quiz' => $quiz->id]) }}">
                                    <i class="fas fa-pencil-alt mr-2"></i>{{ __('Edit') }}
                                </x-dropdown-link>

                                <form id="{{ $quiz->id }}" action="{{ route('admin.quiz.destroy', ['quiz' => $quiz->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
