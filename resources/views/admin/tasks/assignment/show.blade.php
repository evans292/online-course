        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @if ($assignment->teacher['name'] !== null)
                    ...
                    @else
                    <p class="ml-12 text-gray-400 text-sm mt-1">{{ $assignment->admin['name'] }} <span class="text-xs">•</span> {{ $assignment->created_at->format('M d') }}</p>
                    @endif
