        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <ul class="list-reset flex flex-col">
                ...
                <li class="rounded-t relative -mb-px block border p-2 border-grey flex items-center">
                    ...
                    @endif
                    <a href="{{ route('admin.accumulation.show', ['class' => Request::segment(3), 'assignment' => Request::segment(4), 'student' => $acc->student->id, 'accumulation' => $acc->id]) }}" class="hover:text-green-400 text-sm ml-2">{{ $acc->student->name }}</a>
                </li>
                @endforeach
            </ul>
        </div>
