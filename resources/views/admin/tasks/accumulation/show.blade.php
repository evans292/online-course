<x-app-layout>
    ...
    <div class="flex justify-end">
        <div class="w-2/6  sm:px-6 lg:px-8 self-end">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="post" class="ml-5" action="{{ route('admin.accumulation.update', ['class' => Request::segment(3), 'assignment' => Request::segment(4), 'student' => $data[0]->student->id]) }}" novalidate enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class="mb-4">
