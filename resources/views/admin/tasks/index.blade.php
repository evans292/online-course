                        ...
                        <div class="flex justify-between" x-on:click.self="expanded = !expanded">
                            ...
                            <div class="flex self-center mt-3">
                                ...
                                <x-dropdown align="top" width="48" >
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link href="{{ route('admin.assignment.edit', ['class' => Request::segment(3), 'assignment' => $data->id]) }}">
                                            <i class="fas fa-pencil-alt mr-2"></i>{{ __('Edit') }}
                                        </x-dropdown-link>

                                        <form id="{{ $data->id }}" action="{{ route('admin.assignment.destroy', ['assignment' => $data->id]) }}" method="POST">
                                            @csrf
                                            @method('delete')
