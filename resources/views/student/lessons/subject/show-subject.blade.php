                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between mb-2">
                        ...
                        <div>
                            ...
                            <a href="{{ $subject->link }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-red-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150"><i class="fab fa-youtube mr-1"></i>Watch video</a>
                        </div>
                    </div>
                    <hr>
                    <p class="p-1 text-gray-400">{!! $subject->details !!}</p>
                </div>
            </div>
        </div>
    </div>
