...
class QuestionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('teacher.tasks.quiz.question.index', compact('questions', 'quiz'));
    }
    ...
    public function create(Request $request, $classId, $quizId)
    {
        //
        $quiz = Quiz::findOrFail($request->segment(4));
        return view('teacher.tasks.quiz.question.create', compact('quiz'));
    }
    ...
    public function show(Request $request, $classId, $quizId, $questionId)
    {
        ...
        return view('teacher.tasks.quiz.question.show', compact('question', 'quiz'));
    }
    ...
    public function edit(Request $request, $classId, $quizId, $questionId)
    {
        ...
        return view('teacher.tasks.quiz.question.edit', compact('question', 'quiz'));
    }
